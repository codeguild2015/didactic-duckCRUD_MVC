...
//
// Author: Cole Howard (sorta also Patrick, Jaydn and Connor)
//
...
function Wrapper() {
    ...
    var Model = {
        ...
        nonFunc : function() {
            // Does nothing (a dummy callback for the initialization)
        }
    };
    ...
    var Controller = {
        ...
        fetchData : function() {
            ...
            Model.getModel(function() {
                ...
                View.drawTable(Model.currentState); // Initializes app and view
            });
        },
        ...
        updateData : function(pos_str) {
            ...
            Model.getModel();             
            return Model.currentState; // Get's updated model, view feeds update, controller tells model, model updates, passes back to controller to pass to view for refreshed page
        },
    ...
    var View = {
        ...
        populateCell: function(data, r, c, cell) {
            //fills each cell with text, empty cells have placeholder text to maintain table shape
            if (data[c] && data[c][r]) {
