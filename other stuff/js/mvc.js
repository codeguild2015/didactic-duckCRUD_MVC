// An MVC implementation of webpage that uses the Google Sheets API and 
// an API called Sheetsu allowing users to interact with a single, 
// predefined spreadsheet.  Front end is a basic Bootstrap website 
// from template.
//
// Author: Patrick McNally and the rest of code guild 2015
//

;  // Defensive semicolon

// Wrapper function for name space.
function Wrapper() {
